...
define('ORG_URL', 'http://url-tou-site-sas'); // Εδώ ορίζουμε τη διεύθυνση της ιστοσελίδας μας. Π.χ. http://dide.arg.sch.gr/grmixan (ΔΕΝ συμπεριλαμβάνουμε το φάκελο της εφαρμογής εδώ)
...
$am_length = 6; // Πόσους χαρακτήρες ή/και ψηφία έχει ο αριθμός μητρώου των υπαλλήλων της υπηρεσίας
